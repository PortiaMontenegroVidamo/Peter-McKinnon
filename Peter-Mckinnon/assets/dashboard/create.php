...
<!-- include navbar using php -->
    ...
    <form class="create-article" method="post" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF']; ?>">
        <div class="article-editor text bg-primary mb-3">
            ...
            <div class="card-body">
                ...
                <!-- <div class="input-group-append"><input class="input-group-text" type="file" name="submit" value="Upload"> -->
                </div></h6>
                <hr class="my-4">
